              ...
              if (logged) {
                ...
                dispatch(
                  fetchFlights({
                    destFrom,
                    destTo,
                    departDate: departDate?.toLocaleDateString().replace(/\//g, "-") ?? "",
                    arriveDate: arriveDate?.toLocaleDateString().replace(/\//g, "-") ?? "",
                  })
                );
