...
export const paymentUser = createAsyncThunk ("/payment", async (amount:number | 0)=>{
  console.log("linklink",amount);
  const response = await axios.post(`http://localhost:1337/payment/payment`,{"amount":amount})  
